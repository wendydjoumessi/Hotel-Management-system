                ...
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="#" class="message d-flex align-items-center">
                     ...
                     @foreach ($messages as $message)
                        ...
                        <div class="content"><strong class="d-block">{{$message->name}}</strong><span class="d-block">{{$message->message}}</span><small class="date d-block">{{$message->created_at}}</small></div></a><a href="{{url('send_mail',$message->id)}}" class="message d-flex align-items-center">
                     @endforeach
